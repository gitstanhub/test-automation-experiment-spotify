...
public enum Albums {
    ...
    Albums(List<String> albumArtists, String albumName, String albumId, Integer albumTotalTracks, String albumReleaseDate, String albumReleaseDatePrecision, String albumType) {
