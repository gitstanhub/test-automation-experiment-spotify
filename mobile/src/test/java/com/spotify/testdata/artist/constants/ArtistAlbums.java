...
import com.spotify.config.appium.entities.AlbumConfig;
...
public enum ArtistAlbums {
    ...
    ArtistAlbums(List<String> albumArtists, String albumName, Integer albumReleaseYear, String albumFullReleaseDate, String albumType, String albumCopyrightText) {
